...
export default function InvitePage() {
  ...
  if (joined) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-primary-50 to-background p-4" dir="rtl">
        <Card className="w-full max-w-md text-center">
          <CardContent className="py-12 space-y-4">
            <CheckCircle2 className="h-16 w-16 text-green-500 mx-auto" />
            <h2 className="text-xl font-bold text-foreground">ברוכים הבאים!</h2>
            <p className="text-muted-foreground">הצטרפת בהצלחה. מעביר אותך...</p>
          </CardContent>
        </Card>
      </div>
    );
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-primary-50 to-background p-4" dir="rtl">
        <Card className="w-full max-w-md text-center">
          <CardContent className="py-12 space-y-4">
            ...
            <h2 className="text-xl font-bold text-foreground">הזמנה לא תקפה</h2>
            <p className="text-muted-foreground">{info?.reason || 'הקישור אינו פעיל'}</p>
