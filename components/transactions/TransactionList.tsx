  ...
  if (transactions.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center animate-in fade-in duration-300">
        ...
        <p className="text-lg font-medium text-foreground">אין עסקאות להצגה</p>
        <p className="mt-2 text-sm text-muted-foreground">לחץ על כפתור + למטה כדי להוסיף עסקה</p>
      </div>
    );
  }
    ...
    <>
      <div className="space-y-6">
        ...
        {groupedTransactions.today.length > 0 && (
          <div>
            <h3 className="mb-3 text-sm font-medium text-muted-foreground">היום</h3>
        ...
        {groupedTransactions.yesterday.length > 0 && (
          <div>
            <h3 className="mb-3 text-sm font-medium text-muted-foreground">אתמול</h3>
            <div className="space-y-2">
      ...
      <div className="flex items-center gap-3">
        ...
        >
          {IconComponent ? (
            ...
            <Icons.Receipt size={24} className="text-muted-foreground" />
          )}
        </div>
        ...
        <Button
          variant="ghost"
          size="icon"
          className="shrink-0 text-expense-500 hover:bg-red-50 hover:text-expense-500"
          onClick={(e) => {
            e.stopPropagation();
